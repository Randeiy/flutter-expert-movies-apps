...
import 'package:ditonton/domain/entities/tv/tv_entity.dart' as _i6;
...
class MockGetWatchlistTv extends _i1.Mock implements _i3.GetWatchlistTv {
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, List<_i6.TvModel>>> execute() =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [],
        ...
        returnValue:
            _i4.Future<_i2.Either<_i5.Failure, List<_i6.TvModel>>>.value(
                _FakeEither_0<_i5.Failure, List<_i6.TvModel>>(
          this,
          Invocation.method(
            #execute,
            [],
      ...
      ) as _i4.Future<_i2.Either<_i5.Failure, List<_i6.TvModel>>>);
}
